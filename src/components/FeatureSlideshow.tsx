  ...
  },
  {
    svg: (
      <svg width="100%" height="100%" viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle cx="200" cy="80" r="100" stroke="url(#pointsGradient)" strokeWidth="8" fill="none" strokeDasharray="5,5">
          <animate attributeName="strokeDashoffset" from="0" to="10" dur="2s" repeatCount="indefinite" />
        </circle>
        <circle cx="200" cy="80" r="80" stroke="url(#pointsGradient)" strokeWidth="8" fill="none" strokeDasharray="5,5">
          <animate attributeName="strokeDashoffset" from="10" to="0" dur="2s" repeatCount="indefinite" />
        </circle>
        <circle cx="200" cy="80" r="60" stroke="url(#pointsGradient)" strokeWidth="8" fill="none" strokeDasharray="5,5">
          <animate attributeName="strokeDashoffset" from="0" to="10" dur="2s" repeatCount="indefinite" />
        </circle>
        {/* Points Text with Shadow */}
        <text x="200" y="90" textAnchor="middle" fill="#1a237e" fontSize="24" fontFamily="Arial" filter="url(#shadow)">
          10,000
        </text>
        <text x="200" y="120" textAnchor="middle" fill="#1a237e" fontSize="16" fontFamily="Arial" filter="url(#shadow)">
          POINTS
        </text>
        {/* Decorative Elements */}
        <circle cx="100" cy="30" r="10" fill="#9C27B0" opacity="0.3">
          <animate attributeName="r" from="8" to="12" dur="1s" repeatCount="indefinite" />
        </circle>
        <circle cx="300" cy="130" r="15" fill="#2196F3" opacity="0.3">
